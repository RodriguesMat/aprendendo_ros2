...
class R2D2(Node):
    ...
    def run(self):
        ...
        self.frente = Twist(linear=Vector3(x= 0.5,y=0.0,z=0.0),angular=Vector3(x=0.0,y=0.0,z= 0.0))
        self.tras = Twist(linear=Vector3(x= -0.5,y=0.0,z=0.0),angular=Vector3(x=0.0,y=0.0,z= 0.0))
        self.direita = Twist(linear=Vector3(x= 0.0,y=0.5,z=0.0),angular=Vector3(x=0.0,y=0.0,z= 0.0))
        self.esquerda = Twist(linear=Vector3(x= 0.0,y=-0.5,z=0.0),angular=Vector3(x=0.0,y=0.0,z= 0.0))
        self.frente_esquerda = Twist(linear=Vector3(x= 0.5,y=-0.5,z=0.0),angular=Vector3(x=0.0,y=0.0,z= 0.0))
        self.frente_direita = Twist(linear=Vector3(x= 0.5,y=0.5,z=0.0),angular=Vector3(x=0.0,y=0.0,z= 0.0))
        self.tras_esquerda = Twist(linear=Vector3(x= -0.5,y=-0.5,z=0.0),angular=Vector3(x=0.0,y=0.0,z= 0.0))
        self.tras_direita = Twist(linear=Vector3(x= -0.5,y=0.5,z=0.0),angular=Vector3(x=0.0,y=0.0,z= 0.0))
        ...
        self.pub_cmd_vel.publish(self.frente)
        rclpy.spin_once(self)
